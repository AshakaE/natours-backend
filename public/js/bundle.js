...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYXNoYWthZSIsImEiOiJja3dhbHZlaHAybm5wMnZwNm1kZGVlZmdnIn0.mNrbqiikVWLu4Am1EJdWiA';
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: 'http://localhost:5914/api/v1/users/login',
              data: {
                email: email,
                password: password
              }
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://localhost:5914/api/v1/users/updateMyPassword' : 'http://localhost:5914/api/v1/users/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var stripe = Stripe('pk_test_51K1t4YKsrv8lDCbwg3WzfTGPIJW8WFriYlCI4ybvnIpWOUNEffAPaCGi8R04cPfeceyMfsy6NHmpcYAxAsuJBwKz00WK4SEgFT');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://localhost:5914/api/v1/bookings/checkout-session/".concat(tourId));
